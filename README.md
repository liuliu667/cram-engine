...
一个能帮大学生速成通过期末考试的 Claude Code Skill。

对大学生来说，考前一两周突击是常态。麻烦的不是没资料，是有了资料之后只靠自己根本来不及：你得先把零散的考点组织成结构，再逐个理解，然后找办法检验——这三件事光靠翻书和看笔记根本跑不完。

Cram Engine 做的就是帮你以最快速度跑完这条路。底层用了六条在学习科学里被反复验证过的原理——认知负荷控制、精细加工、生成效应、检索练习、间隔效应、元认知监控——通过一套四阶段流水线，把课程重点变成一节一节有人带着你学的交互式课程。
...
定性知识密集的大学课程最合适。文史哲、法学、教育学、新闻传播、社会学、政治学、经管类的大部分期末考都在这个范围里。考试以理解和论述为主就行。

纯定量课不太适合。高等数学、概率论、计量经济学——这类课靠的是海量手算和题型熟练度，跟引擎的理解再迁移路线不一样。

另外得说实话：引擎效果取决于你给的考点质量。如果你完全不知道老师会考什么，它会退化成普通 AI 问答。期末速成的前提没变——你得先有一个考试范围。
