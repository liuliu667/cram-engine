...
一个能帮大学生速成通过期末考试的开源Skill。

对我们大学生来说，考前一两周突击是常态。麻烦的不是没资料，是有了资料之后只靠自己根本来不及：你得先把零散的考点组织成结构，再逐个理解，然后找办法检验——这三件事光靠翻书和看笔记根本跑不完。

Cram Engine 所做的就是帮你以最快速度跑完这条路。底层用了六条在学习科学里被反复验证过的原理——认知负荷控制、精细加工、生成效应、检索练习、间隔效应、元认知监控——通过一套四阶段流水线，把课程重点变成一节一节有人带着你学的交互式课程。
